...
void legotrain_generate_single(const char *module = "__ALL__")
{
  Int_t nFiles = 10;                                                                              //TString(gSystem->Getenv("TEST_FILES_NO")).Atoi();//TEST_FILES_NO
  ...
  auto tokens = outputFiles.Tokenize(",");
